...
class ApkgReader:
    def __init__(self, apkg_path: str):
        ...
        db_path = Path(self.temp_dir).joinpath("collection.anki21")
        if not db_path.exists():
            db_path = db_path.with_name("collection.anki2")
...
if __name__ == "__main__":
    ...
    with ApkgReader(
        "/Users/patarapolw/PycharmProjects/AnkiTools/tests/input/test.apkg"
    ) as apkg:
